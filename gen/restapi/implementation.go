...
var (
	...
	clientID     = os.Getenv("ClientID")     // ⚡ get from environment variable ⚡
	clientSecret = os.Getenv("ClientSecret") // ⚡ get from environment variable ⚡
	...
	callbackURL = "http://localhost:8080/v1/auth/callback" // ⚡ change api=>v1 ⚡
